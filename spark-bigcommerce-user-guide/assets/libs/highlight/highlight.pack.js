        ...
        for (var r = n.firstChild; r; r = r.nextSibling)
          3 === r.nodeType
            ...
            : 1 === r.nodeType &&
              ...
              (t = e(r, t)),
              d(r).match(/br|hr|img|input/) || a.push({ event: 'stop', offset: t, node: r }));
        return t;
      })(e, 0),
      a
    );
          ...
          if (v(n.c[t].bR, e))
            return (
              n.c[t].endSameAsBegin &&
                (n.c[t].eR =
                  ((a = n.c[t].bR.exec(e)[0]), new RegExp(a.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'), 'm'))),
              n.c[t]
            );
      })(n, E);
      if (t)
        return (
          t.skip ? (R += n) : (t.eB && (R += n), s(), t.rB || t.eB || (R = n)), l(t), t.rB ? 0 : n.length
        );
      var r,
        a,
        i = (function e(n, t) {
        ...
        (r.value = (function (e, n, t) {
          ...
          for (; e.length || n.length; ) {
            ...
            if (((a += _(t.substring(r, l[0].offset))), (r = l[0].offset), l === e)) {
              for (
                i.reverse().forEach(u);
                s(l.splice(0, 1)[0]), (l = c()) === e && l.length && l[0].offset === r;
...
hljs.registerLanguage('objectivec', function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: 'class', b: '(' + _.split(' ').join('|') + ')\\b', e: '({|$)', eE: !0, k: _, l: t, c: [e.UTM] },
      { b: '\\.' + e.UIR, r: 0 },
    ],
  };
});
    ...
    c: [
      ...
      { bK: 'new return throw await else', r: 0 },
      {
        ...
        c: [
          ...
          { cN: 'params', b: /\(/, e: /\)/, eB: !0, eE: !0, k: i, r: 0, c: [o, r, e.CBCM] },
          e.CLCM,
          e.CBCM,
        ],
      },
...
hljs.registerLanguage('properties', function (r) {
  ...
  return {
    ...
    c: [
      r.C('^\\s*[!#]', '$'),
      { b: s + e, rB: !0, c: [{ cN: 'attr', b: s, endsParent: !0, r: 0 }], starts: a },
