    ...
    (c = db.support = {}),
        ...
        return e !== l && 9 === e.nodeType && e.documentElement
          ? ((l = e),
            ...
            (c.matchesSelector = Y.test(
              (q =
                m.webkitMatchesSelector || m.mozMatchesSelector || m.oMatchesSelector || m.msMatchesSelector),
            )) &&
              gb(function (a) {
      ...
      (d = db.selectors = {
        ...
        pseudos: {
          ...
          focus: function (a) {
            return (
              a === l.activeElement && (!l.hasFocus || l.hasFocus()) && !!(a.type || a.href || ~a.tabIndex)
            );
          },
          enabled: function (a) {
            return a.disabled === !1;
        ...
        if ((c = d.relative[a[j].type])) m = [qb(rb(m), c)];
          ...
          if (((c = d.filter[a[j].type].apply(null, a[j].matches)), c[s])) {
            ...
            return tb(
              j > 1 && rb(m),
              j > 1 &&
                pb(a.slice(0, j - 1).concat({ value: ' ' === a[j - 2].type ? '*' : '' })).replace(P, '$1'),
              c,
              e > j && ub(a.slice(j, e)),
              f > e && ub((a = a.slice(e))),
              f > e && pb(a),
    ...
    var b,
      ...
      k = {
        ...
        fireWith: function (a, c) {
          return (
            !h || (d && !i) || ((c = c || []), (c = [a, c.slice ? c.slice() : c]), b ? i.push(c) : j(c)), this
          );
        },
        fire: function () {
      ...
      pc[b] =
        (sc && rc) || !qc.test(b)
          ? function (a, b, d) {
              ...
              return (
                d ||
                  ((f = pc[b]), (pc[b] = e), (e = null != c(a, b, d) ? b.toLowerCase() : null), (pc[b] = f)),
                e
              );
            }
          : function (a, b, c) {
